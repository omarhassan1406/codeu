...
VALUES
  ('g0000000-0000-0000-0000-000000000001', 'f0000000-0000-0001-0003-000000000003', 'Server Actions & Mutations Quiz', 70);

-- Quiz for Flutter: RLS Policies lesson
INSERT INTO quizzes (id, lesson_id, title, passing_score)
VALUES
  ('g0000000-0000-0000-0000-000000000002', 'f0000000-0000-0002-0002-000000000003', 'RLS & Security Quiz', 80);

-- Quiz for Rust: WebSocket lesson
INSERT INTO quizzes (id, lesson_id, title, passing_score)
VALUES
  ('g0000000-0000-0000-0000-000000000003', 'f0000000-0000-0004-0004-000000000002', 'WebSocket & Concurrency Quiz', 75);
...
VALUES
  ('h0000000-0000-0000-0000-000000000001', 'g0000000-0000-0000-0000-000000000001', 'What directive must a Server Action use?', 'single_choice', 1, 1),
  ('h0000000-0000-0000-0000-000000000002', 'g0000000-0000-0000-0000-000000000001', 'Which of the following are valid use cases for Server Actions?', 'multiple_choice', 2, 2),
  ('h0000000-0000-0000-0000-000000000003', 'g0000000-0000-0000-0000-000000000001', 'Server Actions can only be used in Server Components.', 'true_false', 1, 3);

INSERT INTO quiz_answers (id, question_id, answer_text, is_correct)
VALUES
  ('i0000000-0000-0000-0000-000000000001', 'h0000000-0000-0000-0000-000000000001', '"use server"', true),
  ('i0000000-0000-0000-0000-000000000002', 'h0000000-0000-0000-0000-000000000001', '"use client"', false),
  ('i0000000-0000-0000-0000-000000000003', 'h0000000-0000-0000-0000-000000000001', '"server only"', false),
  ('i0000000-0000-0000-0000-000000000004', 'h0000000-0000-0000-0000-000000000001', '"use api"', false),
  ('i0000000-0000-0000-0000-000000000005', 'h0000000-0000-0000-0000-000000000002', 'Form submissions', true),
  ('i0000000-0000-0000-0000-000000000006', 'h0000000-0000-0000-0000-000000000002', 'Database mutations', true),
  ('i0000000-0000-0000-0000-000000000007', 'h0000000-0000-0000-0000-000000000002', 'Client-side animations', false),
  ('i0000000-0000-0000-0000-000000000008', 'h0000000-0000-0000-0000-000000000002', 'Revalidating cached data', true),
  ('i0000000-0000-0000-0000-000000000009', 'h0000000-0000-0000-0000-000000000003', 'True', false),
  ('i0000000-0000-0000-0000-000000000010', 'h0000000-0000-0000-0000-000000000003', 'False', true);

-- Quiz 2: RLS & Security
INSERT INTO quiz_questions (id, quiz_id, question_text, question_type, points, sort_order)
VALUES
  ('h0000000-0000-0000-0000-000000000004', 'g0000000-0000-0000-0000-000000000002', 'What does RLS stand for?', 'single_choice', 1, 1),
  ('h0000000-0000-0000-0000-000000000005', 'g0000000-0000-0000-0000-000000000002', 'Which SQL clause defines which rows a user can read?', 'single_choice', 1, 2);

INSERT INTO quiz_answers (id, question_id, answer_text, is_correct)
VALUES
  ('i0000000-0000-0000-0000-000000000011', 'h0000000-0000-0000-0000-000000000004', 'Row Level Security', true),
  ('i0000000-0000-0000-0000-000000000012', 'h0000000-0000-0000-0000-000000000004', 'Record Locking System', false),
  ('i0000000-0000-0000-0000-000000000013', 'h0000000-0000-0000-0000-000000000004', 'Relational Layer Security', false),
  ('i0000000-0000-0000-0000-000000000014', 'h0000000-0000-0000-0000-000000000005', 'USING', true),
  ('i0000000-0000-0000-0000-000000000015', 'h0000000-0000-0000-0000-000000000005', 'CHECK', false),
  ('i0000000-0000-0000-0000-000000000016', 'h0000000-0000-0000-0000-000000000005', 'WHERE', false),
  ('i0000000-0000-0000-0000-000000000017', 'h0000000-0000-0000-0000-000000000005', 'FILTER', false);

-- Quiz 3: WebSocket & Concurrency
INSERT INTO quiz_questions (id, quiz_id, question_text, question_type, points, sort_order)
VALUES
  ('h0000000-0000-0000-0000-000000000006', 'g0000000-0000-0000-0000-000000000003', 'Which crate provides WebSocket support for Actix-web?', 'single_choice', 1, 1),
  ('h0000000-0000-0000-0000-000000000007', 'g0000000-0000-0000-0000-000000000003', 'In Rust, what trait must a type implement to be sent across threads?', 'single_choice', 1, 2);

INSERT INTO quiz_answers (id, question_id, answer_text, is_correct)
VALUES
  ('i0000000-0000-0000-0000-000000000018', 'h0000000-0000-0000-0000-000000000006', 'actix-web-actors', true),
  ('i0000000-0000-0000-0000-000000000019', 'h0000000-0000-0000-0000-000000000006', 'tokio-tungstenite', false),
  ('i0000000-0000-0000-0000-000000000020', 'h0000000-0000-0000-0000-000000000006', 'async-ws', false),
  ('i0000000-0000-0000-0000-000000000021', 'h0000000-0000-0000-0000-000000000006', 'websocket-rs', false),
  ('i0000000-0000-0000-0000-000000000022', 'h0000000-0000-0000-0000-000000000007', 'Send', true),
  ('i0000000-0000-0000-0000-000000000023', 'h0000000-0000-0000-0000-000000000007', 'Sync', false),
  ('i0000000-0000-0000-0000-000000000024', 'h0000000-0000-0000-0000-000000000007', 'Clone', false),
  ('i0000000-0000-0000-0000-000000000025', 'h0000000-0000-0000-0000-000000000007', 'Debug', false);
...
VALUES
  ('a0000000-0000-0000-0000-000000000003', 'g0000000-0000-0000-0000-000000000001', 85.00, true),
  ('a0000000-0000-0000-0000-000000000003', 'g0000000-0000-0000-0000-000000000002', 70.00, false);
